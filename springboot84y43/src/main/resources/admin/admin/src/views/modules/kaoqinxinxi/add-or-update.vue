  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kechenghao" label="课程号" prop="kechenghao">
              <el-input v-model="ruleForm.kechenghao" 
                placeholder="课程号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="上课日" prop="shangkeri">
          <el-select :disabled="ro.shangkeri" v-model="ruleForm.shangkeri" placeholder="请选择上课日">
            <el-option
                v-for="(item,index) in shangkeriOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="上课日" prop="shangkeri">
	      <el-input v-model="ruleForm.shangkeri"
                placeholder="上课日" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="节次" prop="jieci">
        ...
        <div v-else>
          <el-form-item class="input" label="节次" prop="jieci">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="签到状态" prop="qiandaozhuangtai">
          <el-select :disabled="ro.qiandaozhuangtai" v-model="ruleForm.qiandaozhuangtai" placeholder="请选择签到状态">
            <el-option
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhouci = true;
          ...
          if(o=='shangkeri'){
            this.ruleForm.shangkeri = obj[o];
	    this.ro.shangkeri = true;
            continue;
          }
          if(o=='jieci'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.shangkeriOptions = "星期一,星期二,星期三,星期四,星期五,星期六,星期日".split(',')
            this.jieciOptions = "第一节,第二节,第三节,第四节,第五节,第六节,第七节".split(',')
            this.qiandaozhuangtaiOptions = "签到,旷课,迟到,事假,病假".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
    ...
    onSubmit() {
      ...
      if(this.ruleForm.qiandaoshijian>this.ruleForm.jiezhishijian){
        this.$message.error("签到时间不能超过截止时间");
        return
      }
